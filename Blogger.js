$(document).ready(function () {
    ...
    _0x2a7b88 != -0x1 && (_0x2e7ecd = video_id.substring(0x0, _0x2a7b88));
...
}), $('.quickedit').removeAttr('onclick'), $('.quickedit').removeAttr('target'), $('.quickedit').addClass('popWin'), $('.quickedit').attr('data-popWidth', 0x258), $('.quickedit img').remove(), $('.quickedit').append('<i class="icon ion-md-create"></i>');
...
$.each(arr_socmed, function (_0x123231, _0x314917) {
    ...
    $('.poptamv').removeClass('open'), $.magnificPopup.close(), $('#page-loader').fadeIn(0x1f4).delay(0x3e8).fadeOut(0x3e8);
}), $(window).on('load', function () {
    $('#page-loader').fadeOut(0x1f4), $('iframe').each(function () {
        var _0x2b57c7 = $(this).attr('data-src');
        $(this).attr('src', _0x2b57c7), $(this).removeAttr('data-src');
    });
    var _0x482924 = location.href.split('/')[0x0] + '//' + location.href.split('/')[0x2] + '/',
        _0x5a5cfd = location.href.split('/')[0x0] + '//' + location.href.split('/')[0x2] + '/?m=1';
    (!localStorage.getItem('load_notif') && location.href == _0x482924 || location.href == _0x5a5cfd) && ($('a.btnNotif').trigger('click'), localStorage.setItem('load_notif', 0x1));
}), $('img').each(function () {
    ...
    $('header').each(function () {
        $(window).scrollTop() >= 0x1 ? $(this).addClass('onScroll') : $(this).removeClass('onScroll');
    });
...
$(document).on('click', '.waFix', function () {
    $(this).removeClass('show'), sessionStorage.setItem('waFix', true);
}), $(document).on('keypress', '.formWA input, .formWA textarea', function () {
    event.keyCode === 0xd && $(this).parents('.formWA').find('.submit').trigger('click');
    ...
    return kirimWA($(this).parents('.poptamv').attr('id')), true;
});
...
function kirimWA(_0x2e30fd) {
    ...
    $('#' + _0x2e30fd + ' .wajib').each(function () {
        ...
        if ($.trim($(this).val()) == '') return _0x5f1e99 = true, $(this).parents('label').find('.validasi').addClass('show'), $(this).focus(), true;
        else {
            if ($.trim($(this).val()) == 'default') return _0x5f1e99 = true, $(this).parents('label').find('.validasi').addClass('show'), true;
        }
    });
    if (_0x5f1e99 === true) {
        var _0x2ad9bd = '',
        ...
        var _0x49f2d8 = 0x3c0,
            _0x595f9c = 0x21c,
            _0x159291 = Number(screen.width / 0x2 - _0x49f2d8 / 0x2),
            _0x255092 = Number(screen.height / 0x2 - _0x595f9c / 0x2),
...
$(document).on('click', '.popWin', function () {
    ...
    return _0x36dbb0 == null && (_0x36dbb0 = 0x3c0), _0x345337 == null && (_0x345337 = 0x21c), left = Number(screen.width / 0x2 - _0x36dbb0 / 0x2), tops = Number(screen.height / 0x2 - _0x345337 / 0x2), popupWindow = window.open(_0x537f74, '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=1, copyhistory=no, width=' + _0x36dbb0 + ', height=' + _0x345337 + ', top=' + tops + ', left=' + left), popupWindow.focus(), true;
...
$('.btnNotif').click(function () {
    $('.btnNotif span').hide(), sessionStorage.setItem('ss_notif', true);
});
...
(tw_config.FBPixel_ID != null || tw_config.FBPixel_ID != '') && (! function (_0x23b237, _0xd9e45, _0xb690bf, _0x485891, _0x210fed, _0x432c67, _0x1b9acf) {
    ...
    _0x210fed.push = _0x210fed, _0x210fed.loaded = !0x0, _0x210fed.version = '2.0', _0x210fed.queue = [], _0x432c67 = _0xd9e45.createElement(_0xb690bf), _0x432c67.async = !0x0, _0x432c67.src = _0x485891, _0x1b9acf = _0xd9e45.getElementsByTagName(_0xb690bf)[0x0], _0x1b9acf.parentNode.insertBefore(_0x432c67, _0x1b9acf);
